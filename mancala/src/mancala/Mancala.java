...
public class Mancala implements Serializable {
	...
	public void changeNames() {
		String nameOne = JOptionPane.showInputDialog(null, "Enter name for player one (max 10 characters)", "Welcome to Ayo", JOptionPane.QUESTION_MESSAGE);
		if(nameOne != null && nameOne.length() <= 10)
			playerOne.setName(nameOne.replaceAll("\t", " "));
		String nameTwo = JOptionPane.showInputDialog(null, "Enter name for player two (max 10 characters)", "Welcome to Ayo", JOptionPane.QUESTION_MESSAGE);
