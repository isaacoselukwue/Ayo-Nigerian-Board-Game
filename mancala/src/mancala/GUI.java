...
public class GUI implements Serializable{
	...
	public GUI(Mancala mancala) {
		...
		JFrame frame = new JFrame("Ayo Olopon");
	...
	private void createMenu(JFrame frame) {
		...
		JMenuItem changeNames = new JMenuItem("Edit preinstalled names");
	...
	private String createHelpText() {
		...
		sb.append("How to play Ayo.\n\n");
		sb.append("1. The Ayo 'board' is made up of two rows of six holes, or pits, each.\n");
		...
		sb.append("11. The game ends when all six spaces on one side of the Ayo board are empty.\n");
